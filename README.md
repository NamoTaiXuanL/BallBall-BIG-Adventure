# 球球大冒险 (BallBall Big Adventure) v4.4.1

一款2D平台动作冒险游戏，玩家控制一个具有特殊能力的球球角色，在广阔的地图中探索、战斗、收集资源并购买属性增强。现已支持三形态切换系统，提供更丰富的战斗策略！

## 🎮 游戏特色

- **🔄 三形态切换系统**：鼠标滚轮切换A(攻击)、B(默认)、C(防御)三种战斗形态
...
- ✨ **视觉效果升级** - 形态切换反馈优化，浮动文字更大更清晰
- ⚖️ **战斗平衡调整** - 精确的属性配置，提供多样化战斗策略
- 🛠️ **技术实现** - 模块化形态系统，实时属性计算，事件驱动架构

### 版本 4.3.6 - 金币属性系统非持久化修复版 🔄
